...
__attribute__((always_inline)) inline void WSlave::uncheck()
{
  //_client.flush();
  _client.stop();
}
...
__attribute__((always_inline)) inline void WSlave::maintain()
{
#if USE_DHCP
...
__attribute__((always_inline)) inline void WSlave::broadcast()
{
#if USE_BONJOUR
  EthernetBonjour.run();
#endif USE_BONJOUR
